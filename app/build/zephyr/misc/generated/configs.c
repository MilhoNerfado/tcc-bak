...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_MUTEX_GPIO_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MUTEX, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MUTEX_INIT_PRIORITY, 50);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_TCC_GIT_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_G031K8, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_G031K8_STM32G031XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_STM32G031XX, 1);
